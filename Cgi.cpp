...
// std::string Client::concatenatePaths(const std::string& file) 
// {
//     std::string rsc = request.getResource();
//     int i = rsc.size() - 1;
...
//         j--;
//     }
//     if (i == 0 && rsc.size() != 1 && rsc != "/" && filePath[filePath.size() -1] != '/')
//         return "/" + file;
//     if (i == 0 && rsc.size() != 1 && rsc != "/")
//         return file;
